...
const BlogDetail = () => {
  ...
  // Enhanced SafeHTML component with link target handling
  const SafeHTML = ({ html }) => {
    // Configure DOMPurify to allow target attribute
    const config = {
      ALLOWED_TAGS: ['p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'span', 'a', 'strong', 'em', 'ul', 'ol', 'li', 'br'],
    ...
    const processedHtml = processLinks(sanitizedHtml);
